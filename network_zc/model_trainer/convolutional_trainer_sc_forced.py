...
This is for auto cycle to train several model.
"""
...
if __name__ == '__main__':
    for training_start_i in [1600,1650,1700,1750,1800,1850,1900,1950]:
        training_start = training_start_i
        training_num = training_start_i + 457
        # To define the model
        ...
        save_best = ModelCheckpoint('..\..\model\\best\\' + model_name + '@'+str(training_start)+'best.h5',
        ...
        with open(file_helper_unformatted.find_logs_final(model_name+str(training_start)+'_train'), 'w') as f:
