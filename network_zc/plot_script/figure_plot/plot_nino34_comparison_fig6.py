...
row2 = 'historical'
if directly_month == 3:
    row3 = 'CNN-SC          0.96365         0.39543'
    row4 = 'CNN-NOSC    0.96008         0.42552'
if directly_month == 6:
    row3 = 'CNN-SC          0.87537         0.49003'
    row4 = 'CNN-NOSC    0.80694         0.52897'
if directly_month == 9:
    row3 = 'CNN-SC          0.71461         0.54648'
    row4 = 'CNN-NOSC    0.62878         0.58564'
